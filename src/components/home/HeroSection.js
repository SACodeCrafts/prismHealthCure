...
const HeroSection = () => {
  return (
    <section className="flex flex-col  gap-10 relative md:flex-row items-center w-full pt-16 ">

      <img src={bgImage} alt="Healthcare" className="   absolute right-0 -z-10 " />
      <div className=' m-auto pb-[70px] max-w-[1140px] w-full flex gap-14'>
        ...
        <div className="md:w-1/2 mt-8 md:mt-0 lg:w-full max-w-[700px]" >
          <img src={heroImage} alt="Healthcare" className="rounded-lg shadow-lg max-w-[700px]" />
        </div>
      </div>
